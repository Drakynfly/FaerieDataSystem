...
struct FAERIEINVENTORYCONTENT_API FFaerieWeightEditor
{
    GENERATED_BODY()
    ...
    FFaerieWeightEditor(const int32 Weight)
      : Weight(Weight)
    {}
 ...
 */
USTRUCT(BlueprintType)
struct FAERIEINVENTORYCONTENT_API FFaerieWeightEditor_Float
{
	GENERATED_BODY()
	...
	FFaerieWeightEditor_Float(const float Weight)
	  : Weight(Weight)
	{}
...
USTRUCT(BlueprintType)
struct FAERIEINVENTORYCONTENT_API FFaerieItemCapacity : public FFaerieMassFragment
{
    GENERATED_BODY()
    ...
    FFaerieWeightEditor Weight = 100;
...
USTRUCT(BlueprintType)
struct FFaerieWeightAndVolume
{
	GENERATED_BODY()

	FFaerieWeightAndVolume() = default;

	FFaerieWeightAndVolume(const int32 Weight, const int64 Volume)
	  : GramWeight(Weight),
		Volume(Volume)
	{}
	...
	FFaerieWeightAndVolume& operator+=(const FFaerieWeightAndVolume& Other)
	{
	...
	friend FFaerieWeightAndVolume operator+(const FFaerieWeightAndVolume& A, const FFaerieWeightAndVolume& B)
	{
	...
	// Negation operator
	friend FFaerieWeightAndVolume operator-(const FFaerieWeightAndVolume& Other)
	{
		FFaerieWeightAndVolume Out;
