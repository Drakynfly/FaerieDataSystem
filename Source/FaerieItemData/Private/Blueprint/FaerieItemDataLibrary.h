...
public:
	...
	static bool FindFragment(const FFaerieItemProxy& Proxy, /*TSubScriptStructOf<FFaerieMassFragment>*/ UScriptStruct* FragmentType, TInstancedStruct<FFaerieMassFragment>& FoundFragment);
