...
struct FFaerieAssetInfo : public FFaerieMassFragment
{
	GENERATED_BODY()
...
template <>
struct Faerie::ItemData::TMassFragmentTypeTraits<FFaerieAssetInfo> : TMassFragmentTypeTraitsBase<FFaerieAssetInfo>
{
	enum
	{
